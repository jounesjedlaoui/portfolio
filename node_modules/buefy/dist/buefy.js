...
(function (global, factory) {
  ...
  var mergeFn = function mergeFn(target, source) {
    ...
    if (deep || !Object.assign) {
      ...
      var replaced = Object.getOwnPropertyNames(source).map(function (prop) {
        ...
        return _objectSpread$a(_objectSpread$a({}, a), b);
      }, {});
      return _objectSpread$a(_objectSpread$a({}, target), replaced);
    } else {
  ...
  const _hoisted_1$T = ["type", "autocomplete", "maxlength", "value"];
  const _hoisted_2$J = ["maxlength", "value"];
    ...
    return (vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
      ...
      ($props.type !== 'textarea')
        ...
        : (vue.openBlock(), vue.createElementBlock("textarea", vue.mergeProps({
          ...
          }), null, 16 /* FULL_PROPS */, _hoisted_2$J)),
      (_ctx.icon)
                  ...
                  (element.group)
                    ? (vue.openBlock(), vue.createElementBlock("div", {
                        ...
                        ($options.hasGroupSlot)
                          ...
                          : (vue.openBlock(), vue.createElementBlock("span", _hoisted_1$S, vue.toDisplayString(element.group), 1 /* TEXT */))
                      ]))
                    : vue.createCommentVNode("v-if", true),
                  (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(element.items, (option, index) => {
                    return (vue.openBlock(), vue.createElementBlock("a", {
                      ...
                      ($options.hasDefaultSlot)
                        ...
                        : (vue.openBlock(), vue.createElementBlock("span", _hoisted_3$t, vue.toDisplayString($options.getValue(option, true)), 1 /* TEXT */))
    ...
    return (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($options.computedTag), vue.mergeProps({ class: "button" }, _ctx.$attrs, {
      ...
      default: vue.withCtx(() => [
        ($props.iconLeft)
          ...
          : vue.createCommentVNode("v-if", true),
        ($props.label)
          ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_1$R, vue.toDisplayString($props.label), 1 /* TEXT */))
          : (_ctx.$slots.default)
  ...
  function render$W(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (vue.openBlock(), vue.createElementBlock("div", {
      class: vue.normalizeClass(["carousel", {'is-overlay': $props.overlay}]),
      ...
      ($props.progress)
        ? (vue.openBlock(), vue.createElementBlock("progress", {
            key: 0,
            class: vue.normalizeClass(["progress", $props.progressType]),
            value: $data.activeChild,
            max: _ctx.childItems.length - 1
          }, vue.toDisplayString(_ctx.childItems.length - 1), 11 /* TEXT, CLASS, PROPS */, _hoisted_1$Q))
        : vue.createCommentVNode("v-if", true),
      vue.createElementVNode("div", {
        ...
        onTouchend: _cache[3] || (_cache[3] = vue.withModifiers((...args) => ($options.dragEnd && $options.dragEnd(...args)), ["stop"]))
      }, [
        vue.renderSlot(_ctx.$slots, "default"),
        ($props.arrow)
          ? (vue.openBlock(), vue.createElementBlock("div", {
              key: 0,
              class: vue.normalizeClass(["carousel-arrow", {'is-hovered': $props.arrowHover}])
            }, [
      ...
      ($props.autoplay && $props.pauseHover && $props.pauseInfo && $data.isPause)
        ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_2$G, [
            vue.createElementVNode("span", {
              class: vue.normalizeClass(["tag", $props.pauseInfoType])
      ...
      ($props.indicator)
        ? (vue.openBlock(), vue.createElementBlock("div", {
            key: 3,
            class: vue.normalizeClass(["carousel-indicator", $options.indicatorClasses])
          }, [
            (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.sortedItems, (item, index) => {
              return (vue.openBlock(), vue.createElementBlock("a", {
                ...
                vue.renderSlot(_ctx.$slots, "indicators", { i: index }, () => [
                  vue.createElementVNode("span", {
                    class: vue.normalizeClass(["indicator-style", $props.indicatorStyle])
                  }, null, 2 /* CLASS */)
                ])
  ...
  var InjectedChildMixin = (function (parentItemName) {
    ...
    if (hasFlag(flags, sorted)) {
      ...
      mixin.props = _objectSpread$8(_objectSpread$8({}, mixin.props), {}, {
        order: {
          type: Number,
          required: false
        }
      ...
      mixin.computed = _objectSpread$8(_objectSpread$8({}, mixin.computed), {}, {
  ...
  const _hoisted_1$P = { class: "carousel-item" };
  ...
  function render$V(_ctx, _cache, $props, $setup, $data, $options) {
    return (vue.openBlock(), vue.createBlock(vue.Transition, {
      ...
      default: vue.withCtx(() => [
        vue.withDirectives(vue.createElementVNode("div", _hoisted_1$P, [
          vue.renderSlot(_ctx.$slots, "default")
        ], 512 /* NEED_PATCH */), [
  ...
  const _hoisted_2$F = ["srcset", "src", "alt", "width", "sizes", "loading"];
  const _hoisted_3$r = ["src", "alt"];
  const _hoisted_4$j = { key: 1 };

  function render$U(_ctx, _cache, $props, $setup, $data, $options) {
    return (vue.openBlock(), vue.createElementBlock("figure", {
      class: vue.normalizeClass(["b-image-wrapper", $options.figureClasses]),
      style: vue.normalizeStyle($options.figureStyles)
    }, [
      ($options.isCaptionFirst)
        ? (vue.openBlock(), vue.createElementBlock("figcaption", _hoisted_1$O, [
        ...
        default: vue.withCtx(() => [
          ($options.isDisplayed)
            ? (vue.openBlock(), vue.createElementBlock("img", {
                ...
                alt: $props.alt,
                class: vue.normalizeClass($options.imgClasses),
              ...
              }, null, 42 /* CLASS, PROPS, HYDRATE_EVENTS */, _hoisted_2$F))
            : vue.createCommentVNode("v-if", true)
        ]),
        _: 1 /* STABLE */
      }),
          ...
          ($options.isPlaceholderDisplayed)
            ? vue.renderSlot(_ctx.$slots, "placeholder", { key: 0 }, () => [
                vue.createElementVNode("img", {
                  ...
                  alt: $props.alt,
                  class: vue.normalizeClass([$options.imgClasses, "placeholder"])
      ...
      ($options.isCaptionLast)
        ? (vue.openBlock(), vue.createElementBlock("figcaption", _hoisted_4$j, [
            vue.renderSlot(_ctx.$slots, "caption")
          ]))
        : vue.createCommentVNode("v-if", true)
    ], 6 /* CLASS, STYLE */))
  ...
  const _hoisted_1$N = ["onMouseup", "onTouchend"];
  ...
  function render$T(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (vue.openBlock(), vue.createElementBlock("div", {
      class: vue.normalizeClass(["carousel-list", {'has-shadow': $data.scrollIndex > 0}]),
      onMousedown: _cache[0] || (_cache[0] = vue.withModifiers((...args) => ($options.dragStart && $options.dragStart(...args)), ["prevent"])),
      onTouchstart: _cache[1] || (_cache[1] = (...args) => ($options.dragStart && $options.dragStart(...args)))
    }, [
      vue.createElementVNode("div", {
        class: vue.normalizeClass(["carousel-slides", $options.listClass]),
        style: vue.normalizeStyle('transform:translateX('+$options.translation+'px)')
      }, [
        (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($props.data, (list, index) => {
          return (vue.openBlock(), vue.createElementBlock("div", {
            class: vue.normalizeClass(["carousel-slide", {'is-active': $props.asIndicator ? $data.activeItem === index : $data.scrollIndex === index}]),
          ...
          ], 46 /* CLASS, STYLE, PROPS, HYDRATE_EVENTS */, _hoisted_1$N))
        }), 128 /* KEYED_FRAGMENT */))
      ], 6 /* CLASS, STYLE */),
      ($props.arrow)
        ? (vue.openBlock(), vue.createElementBlock("div", {
            key: 0,
            class: vue.normalizeClass(["carousel-arrow", {'is-hovered': $options.settings.arrowHover}])
          }, [
            vue.withDirectives(vue.createVNode(_component_b_icon, {
              class: "has-icons-left",
  ...
  const _hoisted_2$E = ["id", ".indeterminate", "autocomplete", "disabled", "required", "name", "value", "true-value", "false-value", "aria-labelledby"];
  ...
  function render$S(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    ], 42 /* CLASS, PROPS, HYDRATE_EVENTS */, _hoisted_1$M))
  }
  ...
  const _hoisted_2$C = ["aria-hidden"];
    ...
    return (vue.openBlock(), vue.createElementBlock("div", {
      ...
      (!$props.inline)
        ? (vue.openBlock(), vue.createElementBlock("div", {
          ...
          ], 40 /* PROPS, HYDRATE_EVENTS */, _hoisted_1$K))
        : vue.createCommentVNode("v-if", true),
  ...
  const _hoisted_2$B = ["role", "tabindex"];
  const _hoisted_3$o = ["role", "tabindex"];

  function render$P(_ctx, _cache, $props, $setup, $data, $options) {
    return ($props.separator)
      ? (vue.openBlock(), vue.createElementBlock("hr", _hoisted_1$J))
    ...
    return (vue.openBlock(), vue.createElementBlock("div", {
      ...
      vue.createElementVNode("div", _hoisted_1$H, [
        vue.createElementVNode("div", {
          ...
          style: vue.normalizeStyle($options.handStyle)
        }, null, 4 /* STYLE */),
        (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($props.faceNumbers, (num, index) => {
          return (vue.openBlock(), vue.createElementBlock("span", {
            key: index,
            class: vue.normalizeClass(["b-clockpicker-face-number", $options.getFaceNumberClasses(num)]),
            style: vue.normalizeStyle({ transform: $options.getNumberTranslate(num.value) })
          }, [
            vue.createElementVNode("span", null, vue.toDisplayString(num.label), 1 /* TEXT */)
          ], 6 /* CLASS, STYLE */))
        }), 128 /* KEYED_FRAGMENT */))
      ], 512 /* NEED_PATCH */)
    ], 32 /* HYDRATE_EVENTS */))
        ...
        ? (vue.openBlock(), vue.createBlock(_component_b_dropdown, {
            ...
            default: vue.withCtx(() => [
              vue.createElementVNode("div", {
                ...
                (_ctx.inline)
                  ? (vue.openBlock(), vue.createElementBlock("header", _hoisted_2$z, [
                      vue.createElementVNode("div", _hoisted_3$m, [
                        vue.createElementVNode("div", _hoisted_4$h, [
                          vue.createElementVNode("span", {
                            class: vue.normalizeClass(["b-clockpicker-btn", { active: $data.isSelectingHour }]),
                            onClick: _cache[3] || (_cache[3] = $event => ($data.isSelectingHour = true))
                          }, vue.toDisplayString($options.hoursDisplay), 3 /* TEXT, CLASS */),
                          vue.createElementVNode("span", null, vue.toDisplayString(_ctx.hourLiteral), 1 /* TEXT */),
                          vue.createElementVNode("span", {
                            class: vue.normalizeClass(["b-clockpicker-btn", { active: !$data.isSelectingHour }]),
                ...
                vue.createElementVNode("div", _hoisted_6$8, [
                  vue.createElementVNode("div", {
                    ...
                    style: vue.normalizeStyle({ width: $options.faceSize + 'px', height: $options.faceSize + 'px' })
                  }, [
                    (!_ctx.inline)
                      ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_7$8, [
                          vue.createElementVNode("div", {
                            class: vue.normalizeClass(["b-clockpicker-btn", { active: $data.isSelectingHour }]),
                    ...
                    (!_ctx.isHourFormat24 && !_ctx.inline)
                      ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_8$7, [
                          vue.createElementVNode("div", {
                            class: vue.normalizeClass(["b-clockpicker-btn", {
                                      active: _ctx.meridienSelected === _ctx.amString || _ctx.meridienSelected === _ctx.AM
                                  }]),
                ...
                (_ctx.$slots.default !== undefined && _ctx.$slots.default().length)
                  ? (vue.openBlock(), vue.createElementBlock("footer", _hoisted_9$5, [
                      vue.renderSlot(_ctx.$slots, "default")
                    ]))
                  : vue.createCommentVNode("v-if", true)
  ...
  const _hoisted_1$F = ["multiple", "size"];
  const _hoisted_2$y = {
    key: 0,
    value: null,
    disabled: "",
          ...
          ($props.placeholder)
            ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 0 }, [
                ($options.computedValue == null)
                  ? (vue.openBlock(), vue.createElementBlock("option", _hoisted_2$y, vue.toDisplayString($props.placeholder), 1 /* TEXT */))
                  : vue.createCommentVNode("v-if", true)
              ], 64 /* STABLE_FRAGMENT */))
            : vue.createCommentVNode("v-if", true),
          vue.renderSlot(_ctx.$slots, "default")
  ...
  const _hoisted_3$l = /*#__PURE__*/vue.createElementVNode("stop", {
    offset: "0%",
    "stop-color": "#fff"
  }, null, -1 /* HOISTED */);
  const _hoisted_4$g = /*#__PURE__*/vue.createElementVNode("stop", {
    offset: "100%",
    "stop-color": "#000"
  }, null, -1 /* HOISTED */);
  const _hoisted_5$a = [
    ...
    return (vue.openBlock(), vue.createElementBlock("svg", {
      ...
      vue.createElementVNode("defs", null, [
        vue.createElementVNode("linearGradient", {
          ...
          x2: "1",
          y2: "0"
        }, [..._hoisted_5$a], 8 /* PROPS */, _hoisted_2$x),
        vue.createElementVNode("linearGradient", {
        ...
        vue.createElementVNode("clipPath", {
          ...
          vue.createElementVNode("path", { d: $options.haloPath }, null, 8 /* PROPS */, _hoisted_10$3)
  ...
  const _hoisted_1$D = ["aria-datavalues"];
  ...
  const _hoisted_1$B = { class: "color-name" };
  const _hoisted_2$w = { class: "colorpicker-header" };
              ...
              vue.createVNode(_component_b_dropdown_item, {
                ...
                default: vue.withCtx(() => [
                  vue.createElementVNode("div", null, [
                    vue.createElementVNode("header", _hoisted_2$w, [
                  ...
                  fn: vue.withCtx(() => [
                    vue.renderSlot(_ctx.$slots, "trigger", {}, () => [
                      vue.createVNode(_component_b_button, {
                        ...
                        default: vue.withCtx(() => [
                          vue.createElementVNode("span", _hoisted_1$B, vue.toDisplayString($props.colorFormatter($options.computedValue)), 1 /* TEXT */)
                        ]),
                        _: 1 /* STABLE */
  ...
  function render$F(_ctx, _cache, $props, $setup, $data, $options) {
    return (vue.openBlock(), vue.createElementBlock("div", _hoisted_1$A, [
      ($props.showWeekNumber)
        ? (vue.openBlock(), vue.createElementBlock("a", {
            key: 0,
            class: vue.normalizeClass(["datepicker-cell is-week-number", {'is-clickable': $props.weekNumberClickable }]),
            onClick: _cache[0] || (_cache[0] = vue.withModifiers($event => ($options.clickWeekNumber($options.getWeekNumber($props.week[6]))), ["prevent"]))
          }, [
            vue.createElementVNode("span", null, vue.toDisplayString($options.getWeekNumber($props.week[6]).week), 1 /* TEXT */)
          ], 2 /* CLASS */))
        : vue.createCommentVNode("v-if", true),
      (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($props.week, (weekDay, index) => {
        return (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: index }, [
          ($options.selectableDate(weekDay) && !$props.disabled)
            ? (vue.openBlock(), vue.createElementBlock("a", {
                ...
                class: vue.normalizeClass([$options.classObject(weekDay), "datepicker-cell"]),
                role: "button",
                href: "#",
                ...
                vue.createElementVNode("span", null, vue.toDisplayString(weekDay.getDate()), 1 /* TEXT */),
                ($options.eventsDateMatch(weekDay))
                  ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_3$j, [
                      (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.eventsDateMatch(weekDay), (event, evIdx) => {
                        return (vue.openBlock(), vue.createElementBlock("div", {
            ...
            : (vue.openBlock(), vue.createElementBlock("div", {
                ...
                vue.createElementVNode("span", null, vue.toDisplayString(weekDay.getDate()), 1 /* TEXT */),
                ($options.eventsDateMatch(weekDay))
                  ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_4$e, [
                      (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.eventsDateMatch(weekDay), (event, evIdx) => {
                        return (vue.openBlock(), vue.createElementBlock("div", {
                          class: vue.normalizeClass(["event", event.type]),
                          key: evIdx
  ...
  function render$E(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (vue.openBlock(), vue.createElementBlock("section", _hoisted_1$z, [
      vue.createElementVNode("header", _hoisted_2$u, [
        (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.visibleDayNames, (day, index) => {
          return (vue.openBlock(), vue.createElementBlock("div", {
            key: index,
            class: "datepicker-cell"
          }, [
            vue.createElementVNode("span", null, vue.toDisplayString(day), 1 /* TEXT */)
          ]))
        }), 128 /* KEYED_FRAGMENT */))
      ]),
      vue.createElementVNode("div", {
        class: vue.normalizeClass(["datepicker-body", {'has-events':$options.hasEvents}])
      }, [
        (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.weeksInThisMonth, (week, index) => {
          ...
          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.monthDates, (date, index) => {
            return (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: index }, [
              ($options.selectableDate(date) && !$props.disabled)
                ? (vue.openBlock(), vue.createElementBlock("a", {
                    ...
                    ($options.eventsDateMatch(date))
                      ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_4$d, [
                          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.eventsDateMatch(date), (event, evIdx) => {
                            return (vue.openBlock(), vue.createElementBlock("div", {
                              class: vue.normalizeClass(["event", event.type]),
                              key: evIdx
                            }, null, 2 /* CLASS */))
                ...
                : (vue.openBlock(), vue.createElementBlock("div", {
                    key: 1,
                    class: vue.normalizeClass([$options.classObject(date), "datepicker-cell"])
        ...
        ? (vue.openBlock(), vue.createBlock(_component_b_dropdown, {
            ...
            default: vue.withCtx(() => [
              vue.createVNode(_component_b_dropdown_item, {
                ...
                focusable: $props.focusable,
                custom: "",
                class: vue.normalizeClass({'dropdown-horizontal-timepicker': $props.horizontalTimePicker})
              }, {
                default: vue.withCtx(() => [
                  vue.createElementVNode("div", null, [
                    vue.createElementVNode("header", _hoisted_1$x, [
                      (_ctx.$slots.header !== undefined && _ctx.$slots.header().length)
                        ...
                        : (vue.openBlock(), vue.createElementBlock("div", {
                            ...
                            ], 40 /* PROPS, HYDRATE_EVENTS */, _hoisted_2$s), [
                                ...
                                default: vue.withCtx(() => [
                                  (!$options.isTypeMonth)
                                    ? (vue.openBlock(), vue.createBlock(_component_b_select, {
                                        ...
                                        default: vue.withCtx(() => [
                                          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.listOfMonths, (month) => {
                                            return (vue.openBlock(), vue.createElementBlock("option", {
                                              value: month.index,
                                              key: month.name,
                                              disabled: month.disabled || undefined
                                            }, vue.toDisplayString(month.name), 9 /* TEXT, PROPS */, _hoisted_5$9))
                                          }), 128 /* KEYED_FRAGMENT */))
                                        ]),
                                        _: 1 /* STABLE */
                                  ...
                                  vue.createVNode(_component_b_select, {
                                    ...
                                    default: vue.withCtx(() => [
                                      (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.listOfYears, (year) => {
                                        return (vue.openBlock(), vue.createElementBlock("option", {
                                          value: year,
                                          key: year
                                        }, vue.toDisplayString(year), 9 /* TEXT, PROPS */, _hoisted_6$6))
                                      }), 128 /* KEYED_FRAGMENT */))
                                    ]),
                                    _: 1 /* STABLE */
                                  }, 8 /* PROPS */, ["modelValue", "disabled", "size"])
                    ...
                    (!$options.isTypeMonth)
                      ? (vue.openBlock(), vue.createElementBlock("div", {
                          key: 0,
                          class: vue.normalizeClass(["datepicker-content", {'content-horizontal-timepicker': $props.horizontalTimePicker}])
                        }, [
                  ...
                  (_ctx.$slots.default !== undefined && _ctx.$slots.default().length)
                    ? (vue.openBlock(), vue.createElementBlock("footer", {
                        key: 0,
                        class: vue.normalizeClass(["datepicker-footer", {'footer-horizontal-timepicker': $props.horizontalTimePicker}])
                      }, [
                        vue.renderSlot(_ctx.$slots, "default")
                      ], 2 /* CLASS */))
                    : vue.createCommentVNode("v-if", true)
                ...
                default: vue.withCtx(() => [
                  vue.createVNode(_component_b_field, {
                    ...
                    default: vue.withCtx(() => [
                      vue.createVNode(_component_b_select, {
                        ...
                        default: vue.withCtx(() => [
                          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.hours, (hour) => {
                            ...
                            }, vue.toDisplayString(hour.label), 9 /* TEXT, PROPS */, _hoisted_1$w))
                          }), 128 /* KEYED_FRAGMENT */))
                        ]),
                        _: 1 /* STABLE */
                      }, 8 /* PROPS */, ["modelValue", "disabled"]),
                      vue.createElementVNode("span", _hoisted_2$r, vue.toDisplayString(_ctx.hourLiteral), 1 /* TEXT */),
                      vue.createVNode(_component_b_select, {
                        ...
                        default: vue.withCtx(() => [
                          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.minutes, (minute) => {
                            ...
                            }, vue.toDisplayString(minute.label), 9 /* TEXT, PROPS */, _hoisted_3$g))
                          }), 128 /* KEYED_FRAGMENT */))
                        ]),
                        _: 1 /* STABLE */
                      }, 8 /* PROPS */, ["modelValue", "disabled"]),
                      (_ctx.enableSeconds)
                        ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 0 }, [
                            vue.createElementVNode("span", _hoisted_4$b, vue.toDisplayString(_ctx.minuteLiteral), 1 /* TEXT */),
                            vue.createVNode(_component_b_select, {
                              ...
                              default: vue.withCtx(() => [
                                (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.seconds, (second) => {
                                  ...
                                  }, vue.toDisplayString(second.label), 9 /* TEXT, PROPS */, _hoisted_5$8))
                                }), 128 /* KEYED_FRAGMENT */))
                              ]),
                              _: 1 /* STABLE */
                            }, 8 /* PROPS */, ["modelValue", "disabled"]),
                            vue.createElementVNode("span", _hoisted_6$5, vue.toDisplayString(_ctx.secondLiteral), 1 /* TEXT */)
                          ], 64 /* STABLE_FRAGMENT */))
                        : vue.createCommentVNode("v-if", true),
                      (!_ctx.isHourFormat24)
                        ? (vue.openBlock(), vue.createBlock(_component_b_select, {
                            ...
                            default: vue.withCtx(() => [
                              (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.meridiens, (meridien) => {
                                return (vue.openBlock(), vue.createElementBlock("option", {
                                  value: meridien,
                                  key: meridien
                                }, vue.toDisplayString(meridien), 9 /* TEXT, PROPS */, _hoisted_7$5))
                              }), 128 /* KEYED_FRAGMENT */))
                            ]),
                            _: 1 /* STABLE */
                          }, 8 /* PROPS */, ["modelValue", "disabled"]))
                  ...
                  (_ctx.$slots.default !== undefined)
                    ? (vue.openBlock(), vue.createElementBlock("footer", _hoisted_8$5, [
                        vue.renderSlot(_ctx.$slots, "default")
                      ]))
                    : vue.createCommentVNode("v-if", true)
                ]),
                ...
                ($props.component)
                  ...
                  : ($props.content)
                    ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 1 }, [
                        ...
                        vue.createElementVNode("div", { innerHTML: $props.content }, null, 8 /* PROPS */, _hoisted_2$p)
                      ], 64 /* STABLE_FRAGMENT */))
                    : vue.renderSlot(_ctx.$slots, "default", {
                        key: 2,
    ...
    return (vue.openBlock(), vue.createBlock(vue.Transition, { name: _ctx.animation }, {
      default: vue.withCtx(() => [
        ($data.isActive)
          ? vue.withDirectives((vue.openBlock(), vue.createElementBlock("div", {
              key: 0,
              class: vue.normalizeClass(["dialog modal is-active", $options.dialogClass]),
              role: $props.ariaRole,
              ...
              vue.createElementVNode("div", _hoisted_2$o, [
                ($props.title)
                  ? (vue.openBlock(), vue.createElementBlock("header", _hoisted_3$d, [
                      vue.createElementVNode("p", _hoisted_4$9, vue.toDisplayString($props.title), 1 /* TEXT */)
                    ]))
                  : vue.createCommentVNode("v-if", true),
                vue.createElementVNode("section", {
                  class: vue.normalizeClass(["modal-card-body", { 'is-titleless': !$props.title, 'is-flex': $props.hasIcon }])
                }, [
                    ...
                    vue.createElementVNode("div", _hoisted_7$4, [
                      vue.createElementVNode("p", null, [
                        (_ctx.$slots.default)
                          ...
                          : (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 1 }, [
                              vue.createCommentVNode(" eslint-disable-next-line vue/no-v-html "),
                              vue.createElementVNode("div", { innerHTML: $props.message }, null, 8 /* PROPS */, _hoisted_8$4)
                            ], 64 /* STABLE_FRAGMENT */))
                      ]),
                      ($props.hasInput)
                        ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_9$3, [
                            vue.createElementVNode("div", _hoisted_10$2, [
                              vue.withDirectives(vue.createElementVNode("input", vue.mergeProps({
                                ...
                                onKeydown: _cache[4] || (_cache[4] = vue.withKeys((...args) => ($options.confirm && $options.confirm(...args)), ["enter"]))
                              }), null, 16 /* FULL_PROPS */), [
                                [vue.vModelDynamic, $data.prompt]
                              ])
                            ]),
                            vue.createElementVNode("p", _hoisted_11$2, vue.toDisplayString($data.validationMessage), 1 /* TEXT */)
                          ]))
                        : vue.createCommentVNode("v-if", true)
                    ])
                  ])
                ...
                vue.createElementVNode("footer", _hoisted_12$2, [
                  ($options.showCancel)
                    ? (vue.openBlock(), vue.createBlock(_component_b_button, {
                        key: 0,
                        ref: "cancelButton",
                  ...
                  vue.createVNode(_component_b_button, {
                    ...
                    default: vue.withCtx(() => [
                      vue.createTextVNode(vue.toDisplayString($props.confirmText), 1 /* TEXT */)
                    ]),
                    _: 1 /* STABLE */
    ...
    function createDialog(_onConfirm, _onCancel) {
      ...
      var vueInstance = vue.createApp({
        ...
        render: function render() {
          this.dialogVNode = vue.h(script$D, _objectSpread$7(_objectSpread$7({}, propsData), {}, {
  ...
  const _hoisted_1$s = /*#__PURE__*/vue.createElementVNode("div", { class: "loading-icon" }, null, -1 /* HOISTED */);
    ...
    _createClass(LoadingProgrammatic, [{
      ...
      value: function open(params) {
        ...
        var vueInstance = vue.createApp({
          ...
          render: function render() {
            this.loadingVNode = vue.h(script$C, _objectSpread$6(_objectSpread$6({}, propsData), {}, {
  ...
  function render$v(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
      ($props.label || _ctx.$slots.label)
        ? (vue.openBlock(), vue.createElementBlock("p", _hoisted_1$q, [
            ($props.label)
              ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 0 }, [
                  ($props.icon)
                    ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 0 }, [
      ...
      (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.tag), vue.mergeProps(_ctx.fallthroughAttrs, {
        ...
        default: vue.withCtx(() => [
          ($props.icon)
            ...
            : vue.createCommentVNode("v-if", true),
          ($props.label)
            ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_2$m, vue.toDisplayString($props.label), 1 /* TEXT */))
  ...
  var Plugin$M = {
    install: function install(Vue) {
      ...
      registerComponent(Vue, script$A, 'BMenuList');
      registerComponent(Vue, script$z);
    }
  };
  use(Plugin$M);
      ...
      default: vue.withCtx(() => [
        vue.withDirectives(vue.createElementVNode("article", {
          ...
          (_ctx.$slots.header || _ctx.title)
            ? (vue.openBlock(), vue.createElementBlock("header", _hoisted_1$o, [
                (_ctx.$slots.header)
                  ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_2$l, [
                      vue.renderSlot(_ctx.$slots, "header")
                    ]))
                  : (_ctx.title)
                    ? (vue.openBlock(), vue.createElementBlock("p", _hoisted_3$c, vue.toDisplayString(_ctx.title), 1 /* TEXT */))
                    : vue.createCommentVNode("v-if", true),
                (_ctx.closable)
            ...
            : vue.createCommentVNode("v-if", true),
          (_ctx.$slots.default)
            ? (vue.openBlock(), vue.createElementBlock("section", _hoisted_5$6, [
    ...
    _createClass(ModalProgrammatic, [{
      ...
      value: function open(params) {
        ...
        var vueInstance = vue.createApp({
          ...
          render: function render() {
            this.modalVNode = vue.h(script$E, _objectSpread$5(_objectSpread$5({}, propsData), {}, {
              onClose: function onClose() {
                vueInstance.unmount();
              },
    ...
    return (vue.openBlock(), vue.createElementBlock("div", {
      ...
      ($options.isNative)
        ? (vue.openBlock(), vue.createElementBlock("progress", {
            ...
            max: $props.max,
            value: $props.value
          }, vue.toDisplayString($options.newValue), 11 /* TEXT, CLASS, PROPS */, _hoisted_1$n))
        : vue.renderSlot(_ctx.$slots, "bar", { key: 1 }),
      ($options.isNative && $props.showValue)
        ? (vue.openBlock(), vue.createElementBlock("p", _hoisted_2$k, [
            vue.renderSlot(_ctx.$slots, "default", {}, () => [
    ...
    _createClass(NotificationProgrammatic, [{
      ...
      value: function open(params) {
        ...
        var vueInstance = vue.createApp({
          ...
          render: function render() {
            this.noticeVNode = vue.h(script$v, _objectSpread$3(_objectSpread$3({}, propsData), {}, {
              onClose: function onClose() {
                if (_onClose != null) {
                  _onClose();
                }
  ...
  const _hoisted_2$i = /*#__PURE__*/vue.createElementVNode("span", { "aria-hidden": "true" }, null, -1 /* HOISTED */);
  const _hoisted_3$a = /*#__PURE__*/vue.createElementVNode("span", { "aria-hidden": "true" }, null, -1 /* HOISTED */);
  const _hoisted_4$6 = /*#__PURE__*/vue.createElementVNode("span", { "aria-hidden": "true" }, null, -1 /* HOISTED */);
  const _hoisted_5$4 = [
    _hoisted_2$i,
    _hoisted_3$a,
    _hoisted_4$6
  ...
  function render$m(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
      ...
      (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.controlsLeft, (control) => {
        return (vue.openBlock(), vue.createElementBlock("p", {
          ...
          vue.createElementVNode("button", {
            type: "button",
            class: vue.normalizeClass(["button", $options.buttonClasses]),
      ...
      (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.controlsRight, (control) => {
        return (vue.openBlock(), vue.createElementBlock("p", {
          key: control,
          class: vue.normalizeClass(['control', control]),
  ...
  const _hoisted_7$2 = /*#__PURE__*/vue.createElementVNode("span", { class: "pagination-ellipsis" }, "…", -1 /* HOISTED */);
  const _hoisted_8$2 = [
    _hoisted_7$2
  ];
  ...
  function render$k(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (vue.openBlock(), vue.createElementBlock("nav", {
      ...
      ($props.simple)
        ? (vue.openBlock(), vue.createElementBlock("small", _hoisted_3$9, [
            ($props.perPage == 1)
              ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 0 }, [
        ...
        : (vue.openBlock(), vue.createElementBlock("ul", _hoisted_4$5, [
            ...
            ($options.hasFirst)
              ? (vue.openBlock(), vue.createElementBlock("li", _hoisted_5$3, [
                  (_ctx.$slots.default)
                    ? vue.renderSlot(_ctx.$slots, "default", {
                        key: 0,
            ...
            ($options.hasFirstEllipsis)
              ? (vue.openBlock(), vue.createElementBlock("li", _hoisted_6$2, [..._hoisted_8$2]))
              : vue.createCommentVNode("v-if", true),
            ...
            ($options.hasLastEllipsis)
              ? (vue.openBlock(), vue.createElementBlock("li", _hoisted_9$2, [..._hoisted_11$1]))
              : vue.createCommentVNode("v-if", true),
            ($options.hasLast)
  ...
  function render$j(_ctx, _cache, $props, $setup, $data, $options) {
    return (vue.openBlock(), vue.createElementBlock("div", {
      ...
      ($options.newShowValue)
        ? (vue.openBlock(), vue.createElementBlock("p", _hoisted_2$f, [
            vue.renderSlot(_ctx.$slots, "default", {}, () => [
              vue.createTextVNode(vue.toDisplayString($options.newValue), 1 /* TEXT */)
            ])
          ]))
  ...
  function render$h(_ctx, _cache, $props, $setup, $data, $options) {
    return (vue.openBlock(), vue.createElementBlock("div", {
      ...
      vue.createElementVNode("label", {
        class: vue.normalizeClass(["b-radio radio button", $options.labelClass]),
        ref: "label",
        disabled: _ctx.disabledOrUndefined,
        onClick: _cache[4] || (_cache[4] = (...args) => (_ctx.focus && _ctx.focus(...args))),
        onKeydown: _cache[5] || (_cache[5] = vue.withKeys(vue.withModifiers($event => (_ctx.$refs.label.click()), ["prevent"]), ["enter"]))
  ...
  function render$g(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (vue.openBlock(), vue.createElementBlock("div", {
      class: vue.normalizeClass(["rate", { 'is-disabled': $props.disabled, 'is-spaced': $props.spaced, 'is-rtl': $props.rtl }])
    }, [
      (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($props.max, (item, index) => {
        return (vue.openBlock(), vue.createElementBlock("div", {
          class: vue.normalizeClass(["rate-item", $options.rateClass(item)]),
          key: index,
          ...
          ($options.checkHalf(item))
            ? (vue.openBlock(), vue.createBlock(_component_b_icon, {
                ...
                icon: $props.icon,
                size: $props.size,
                style: vue.normalizeStyle($options.halfStyle)
      ...
      ($props.showText || $props.showScore || $props.customText)
        ? (vue.openBlock(), vue.createElementBlock("div", {
            key: 0,
            class: vue.normalizeClass(["rate-text", $props.size])
          }, [
            vue.createElementVNode("span", null, vue.toDisplayString($options.showMe), 1 /* TEXT */),
            ($props.customText && !$props.showText)
              ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_2$c, vue.toDisplayString($props.customText), 1 /* TEXT */))
              : vue.createCommentVNode("v-if", true)
          ], 2 /* CLASS */))
        : vue.createCommentVNode("v-if", true)
    ], 2 /* CLASS */))
  ...
  var Plugin$q = {
    install: function install(Vue) {
      // explicit `name` is needed to avoid name mangling of
      // Functional Component in production
      registerComponent(Vue, script$j, 'BSkeleton');
    }
  };
  use(Plugin$q);
  var Plugin$r = Plugin$q;
      ...
      vue.createVNode(_component_b_tooltip, {
        ...
        default: vue.withCtx(() => [
          vue.createElementVNode("div", vue.mergeProps({
            ...
            onKeydown: [
              _cache[4] || (_cache[4] = vue.withKeys(vue.withModifiers((...args) => ($options.onLeftKeyDown && $options.onLeftKeyDown(...args)), ["prevent"]), ["left"])),
              _cache[5] || (_cache[5] = vue.withKeys(vue.withModifiers((...args) => ($options.onRightKeyDown && $options.onRightKeyDown(...args)), ["prevent"]), ["right"])),
              _cache[6] || (_cache[6] = vue.withKeys(vue.withModifiers((...args) => ($options.onLeftKeyDown && $options.onLeftKeyDown(...args)), ["prevent"]), ["down"])),
              _cache[7] || (_cache[7] = vue.withKeys(vue.withModifiers((...args) => ($options.onRightKeyDown && $options.onRightKeyDown(...args)), ["prevent"]), ["up"])),
              _cache[8] || (_cache[8] = vue.withKeys(vue.withModifiers((...args) => ($options.onHomeKeyDown && $options.onHomeKeyDown(...args)), ["prevent"]), ["home"])),
              _cache[9] || (_cache[9] = vue.withKeys(vue.withModifiers((...args) => ($options.onEndKeyDown && $options.onEndKeyDown(...args)), ["prevent"]), ["end"]))
            ]
          }), [
            ($props.indicator)
              ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_2$a, vue.toDisplayString($options.formattedValue), 1 /* TEXT */))
              : vue.createCommentVNode("v-if", true)
  ...
  function render$d(_ctx, _cache, $props, $setup, $data, $options) {
    return (vue.openBlock(), vue.createElementBlock("div", {
      class: vue.normalizeClass(["b-slider-tick", { 'is-tick-hidden': $options.hidden }]),
      style: vue.normalizeStyle($options.getTickStyle($options.position))
    }, [
      (_ctx.$slots.default)
  ...
  function render$c(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (vue.openBlock(), vue.createElementBlock("div", {
      class: vue.normalizeClass(["b-slider", [$props.size, $props.type, $options.rootClasses ]]),
      ...
      vue.createElementVNode("div", _hoisted_1$b, [
        ...
        ($props.ticks)
          ? (vue.openBlock(true), vue.createElementBlock(vue.Fragment, { key: 0 }, vue.renderList($options.tickValues, (val, key) => {
        ...
        vue.withDirectives(vue.createElementVNode("div", {
          ...
          ($props.cancelText)
            ? (vue.openBlock(), vue.createElementBlock("div", {
                ...
                vue.createElementVNode("button", _hoisted_3$7, vue.toDisplayString($props.cancelText), 1 /* TEXT */)
              ]))
            : vue.createCommentVNode("v-if", true),
          ($props.actionText)
            ? (vue.openBlock(), vue.createElementBlock("div", {
                ...
                vue.createElementVNode("button", _hoisted_4$4, vue.toDisplayString($props.actionText), 1 /* TEXT */)
              ], 2 /* CLASS */))
            : vue.createCommentVNode("v-if", true)
  ...
  function render$a(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (vue.openBlock(), vue.createElementBlock("div", {
              ...
              vue.createElementVNode("a", {
                ...
                vue.createElementVNode("div", _hoisted_3$6, [
                  (childItem.icon)
                    ...
                    : (childItem.step)
                      ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_4$3, vue.toDisplayString(childItem.step), 1 /* TEXT */))
                      : vue.createCommentVNode("v-if", true)
                ]),
                vue.createElementVNode("div", _hoisted_5$2, [
                  vue.createElementVNode("span", _hoisted_6$1, vue.toDisplayString(childItem.label), 1 /* TEXT */)
                ])
      ...
      vue.renderSlot(_ctx.$slots, "navigation", {
        ...
        ($props.hasNavigation)
          ? (vue.openBlock(), vue.createElementBlock("nav", _hoisted_7$1, [
              vue.createElementVNode("a", {
                role: "button",
                class: "pagination-previous",
  ...
  function render$9(_ctx, _cache, $props, $setup, $data, $options) {
    return (vue.openBlock(), vue.createElementBlock("label", {
      class: vue.normalizeClass(["switch", $options.newClass]),
      ref: "label",
      disabled: $options.disabledOrUndefined,
      ...
      vue.createElementVNode("span", {
        class: vue.normalizeClass(["check", $options.checkClasses])
      }, null, 2 /* CLASS */),
              ...
              default: vue.withCtx(() => [
                ...
                (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.sortableColumns, (column, index) => {
                  return (vue.openBlock(), vue.createElementBlock("option", {
                    key: index,
                    value: index
                  }, vue.toDisplayString(column.label), 9 /* TEXT, PROPS */, _hoisted_4$2))
                }), 128 /* KEYED_FRAGMENT */))
              ]),
              _: 1 /* STABLE */
            }, 8 /* PROPS */, ["modelValue"])),
      ...
      vue.createElementVNode("div", {
        ...
        vue.createElementVNode("table", {
          ...
          ($options.newColumns.length && $props.showHeader)
            ? (vue.openBlock(), vue.createElementBlock("thead", _hoisted_2$4, [
                vue.createElementVNode("tr", null, [
                  ($options.showDetailRowIcon)
                    ? (vue.openBlock(), vue.createElementBlock("th", _hoisted_3$2))
                    : vue.createCommentVNode("v-if", true),
  ...
  function render$5(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (vue.openBlock(), vue.createElementBlock("div", {
      class: vue.normalizeClass(["b-tabs", $options.mainClasses])
    }, [
      vue.createElementVNode("nav", {
        class: vue.normalizeClass(["tabs", $options.navClasses]),
        ...
        vue.createElementVNode("ul", {
          ...
          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.items, (childItem) => {
            return vue.withDirectives((vue.openBlock(), vue.createElementBlock("li", {
              key: childItem.uniqueValue,
              class: vue.normalizeClass([ childItem.headerClass, { 'is-active': childItem.isActive,
              ...
              (childItem.$slots.header)
                ...
                : (vue.openBlock(), vue.createElementBlock("a", {
                    ...
                    (childItem.icon)
                      ...
                      : vue.createCommentVNode("v-if", true),
                    vue.createElementVNode("span", null, vue.toDisplayString(childItem.label), 1 /* TEXT */)
  ...
  function render$3(_ctx, _cache, $props, $setup, $data, $options) {
    return (vue.openBlock(), vue.createElementBlock("div", {
      class: vue.normalizeClass(["tags", { 'has-addons': $props.attached }])
    }, [
      vue.renderSlot(_ctx.$slots, "default")
    ], 2 /* CLASS */))
  }
  ...
  function render$2(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
      ...
      ($props.hasCounter && ($props.maxtags || _ctx.maxlength))
        ? (vue.openBlock(), vue.createElementBlock("small", _hoisted_2$1, [
      ...
      default: vue.withCtx(() => [
        vue.withDirectives(vue.createElementVNode("div", {
          ...
          (_ctx.$slots.default)
            ...
            : (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 1 }, [
                vue.createCommentVNode(" eslint-disable-next-line vue/no-v-html "),
                vue.createElementVNode("div", { innerHTML: _ctx.message }, null, 8 /* PROPS */, _hoisted_2)
              ], 64 /* STABLE_FRAGMENT */))
