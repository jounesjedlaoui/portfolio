import { s as script$3 } from './Tooltip-WHq2LJas.js';
import { c as config } from './config-nHWiBviw.js';
import { C as CompatFallthroughMixin } from './CompatFallthroughMixin-Ev2XGfi3.js';
import { resolveComponent, openBlock, createElementBlock, mergeProps, createVNode, withCtx, createElementVNode, withKeys, withModifiers, toDisplayString, createCommentVNode, normalizeClass, normalizeStyle, renderSlot, Fragment, renderList, createBlock } from 'vue';
import { b as bound } from './helpers-O9h6_ICO.js';
    ...
    createVNode(_component_b_tooltip, {
      ...
      default: withCtx(() => [
        createElementVNode("div", mergeProps({
          ...
          ($props.indicator)
            ? (openBlock(), createElementBlock("span", _hoisted_2, toDisplayString($options.formattedValue), 1 /* TEXT */))
