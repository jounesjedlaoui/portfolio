...
var InjectedChildMixin = require('./InjectedChildMixin-X_TBgXDe.js');
var helpers = require('./helpers-bVbODwYf.js');
var vue = require('vue');
var Image = require('./Image-wlRn2-6e.js');
  ...
  return (vue.openBlock(), vue.createElementBlock("div", {
    ...
    ($props.progress)
      ? (vue.openBlock(), vue.createElementBlock("progress", {
        ...
        }, vue.toDisplayString(_ctx.childItems.length - 1), 11 /* TEXT, CLASS, PROPS */, _hoisted_1$2))
...
var script = {
    ...
    components: {
        [Icon.script.name]: Icon.script,
        [Image.script.name]: Image.script
    },
    props: {
        data: {
            type: Array,
