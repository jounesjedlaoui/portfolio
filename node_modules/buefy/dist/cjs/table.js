...
var Pagination = require('./Pagination-GdQnp29H.js');
...
var SlotComponent = require('./SlotComponent-D6HwctPm.js');
...
require('./CheckRadioMixin-tbFOgamu.js');
                    ...
                    if (Number.isInteger(value)) {
                        ...
                        if (Array.isArray(value)) {
                            const valid = value.some((val) =>
                                re.test(helpers.removeDiacriticsFromString(val)) || re.test(val)
                            );
