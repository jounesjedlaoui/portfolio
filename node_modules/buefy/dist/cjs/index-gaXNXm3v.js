...
function _possibleConstructorReturn(self, call) {
  if (call && (_typeof._typeof(call) === "object" || typeof call === "function")) {
    return call;
  } else if (call !== void 0) {
...
var ColorTypeError = /*#__PURE__*/function (_Error) {
  ...
  function ColorTypeError() {
    classCallCheck._classCallCheck(this, ColorTypeError);
    return _super.call(this, 'ColorTypeError: type must be hex(a), rgb(a) or hsl(a)');
  }
  return classCallCheck._createClass(ColorTypeError);
}( /*#__PURE__*/_wrapNativeSuper(Error));
var Color = /*#__PURE__*/function (_Symbol$toString) {
  function Color() {
    var _this = this;
    classCallCheck._classCallCheck(this, Color);
  ...
  classCallCheck._createClass(Color, [{
    key: "getHue",
    ...
    value: function parse() {
      ...
      if (_typeof._typeof(args[0]) === 'object') {
    ...
    value: function parseObject(object) {
      var color = new Color();
      if (object === null || _typeof._typeof(object) !== 'object') {
        return color;
      }
