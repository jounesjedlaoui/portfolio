...
require('./CompatFallthroughMixin-ZOMao9mo.js');
require('./FormElementMixin-RZ3syZQl.js');
require('./helpers-bVbODwYf.js');
require('./typeof-fhICEa4F.js');
require('./trapFocus-xJvymH_-.js');
      ...
      ? (vue.openBlock(), vue.createBlock(_component_b_dropdown, {
          ...
          default: vue.withCtx(() => [
            vue.createElementVNode("div", {
              ...
              (_ctx.inline)
                ? (vue.openBlock(), vue.createElementBlock("header", _hoisted_2, [
              ...
              (_ctx.$slots.default !== undefined && _ctx.$slots.default().length)
                ? (vue.openBlock(), vue.createElementBlock("footer", _hoisted_9, [
