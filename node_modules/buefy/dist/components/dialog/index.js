...
(function (global, factory) {
                ...
                ($props.component)
                  ...
                  : ($props.content)
                    ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 1 }, [
                        ...
                        vue.createElementVNode("div", { innerHTML: $props.content }, null, 8 /* PROPS */, _hoisted_2$2)
                      ], 64 /* STABLE_FRAGMENT */))
  ...
  script$2.__file = "src/components/modal/Modal.vue";
    ...
    return (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($options.computedTag), vue.mergeProps({ class: "button" }, _ctx.$attrs, {
      ...
      default: vue.withCtx(() => [
        ($props.iconLeft)
          ...
          : vue.createCommentVNode("v-if", true),
        ($props.label)
          ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_1$1, vue.toDisplayString($props.label), 1 /* TEXT */))
          : (_ctx.$slots.default)
        ...
        ($data.isActive)
          ? vue.withDirectives((vue.openBlock(), vue.createElementBlock("div", {
              ...
              vue.createElementVNode("div", _hoisted_2, [
                ($props.title)
                  ? (vue.openBlock(), vue.createElementBlock("header", _hoisted_3, [
                      vue.createElementVNode("p", _hoisted_4, vue.toDisplayString($props.title), 1 /* TEXT */)
                    ]))
                  : vue.createCommentVNode("v-if", true),
                    ...
                    vue.createElementVNode("div", _hoisted_7, [
                      vue.createElementVNode("p", null, [
                        (_ctx.$slots.default)
                          ...
                          : (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 1 }, [
                              vue.createCommentVNode(" eslint-disable-next-line vue/no-v-html "),
                              vue.createElementVNode("div", { innerHTML: $props.message }, null, 8 /* PROPS */, _hoisted_8)
                            ], 64 /* STABLE_FRAGMENT */))
                      ]),
                      ($props.hasInput)
                        ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_9, [
                            ...
                            vue.createElementVNode("p", _hoisted_11, vue.toDisplayString($data.validationMessage), 1 /* TEXT */)
                          ]))
                        : vue.createCommentVNode("v-if", true)
                    ])
                  ])
