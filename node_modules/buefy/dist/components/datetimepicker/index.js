...
(function (global, factory) {
      ...
      return (vue.openBlock(), vue.createElementBlock("div", {
        ...
        (!$props.inline)
          ? (vue.openBlock(), vue.createElementBlock("div", {
            ...
            ], 40 /* PROPS, HYDRATE_EVENTS */, _hoisted_1$a))
    ...
    const _hoisted_2$9 = ["role", "tabindex"];
    const _hoisted_3$6 = ["role", "tabindex"];

    function render$a(_ctx, _cache, $props, $setup, $data, $options) {
      return ($props.separator)
        ? (vue.openBlock(), vue.createElementBlock("hr", _hoisted_1$9))
    ...
    const _hoisted_1$8 = ["type", "autocomplete", "maxlength", "value"];
    const _hoisted_2$8 = ["maxlength", "value"];
            ...
            ($props.placeholder)
              ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 0 }, [
                  ($options.computedValue == null)
                    ? (vue.openBlock(), vue.createElementBlock("option", _hoisted_2$6, vue.toDisplayString($props.placeholder), 1 /* TEXT */))
                    : vue.createCommentVNode("v-if", true)
                ], 64 /* STABLE_FRAGMENT */))
              : vue.createCommentVNode("v-if", true),
            vue.renderSlot(_ctx.$slots, "default")
            ...
            ($options.selectableDate(weekDay) && !$props.disabled)
              ? (vue.openBlock(), vue.createElementBlock("a", {
                  ...
                  ($options.eventsDateMatch(weekDay))
                    ...
                    : vue.createCommentVNode("v-if", true)
                ], 42 /* CLASS, PROPS, HYDRATE_EVENTS */, _hoisted_2$5))
              : (vue.openBlock(), vue.createElementBlock("div", {
                  key: 1,
                  class: vue.normalizeClass([$options.classObject(weekDay), "datepicker-cell"])
                }, [
                ...
                ($options.selectableDate(date) && !$props.disabled)
                  ? (vue.openBlock(), vue.createElementBlock("a", {
                      ...
                      ($options.eventsDateMatch(date))
                        ...
                        : vue.createCommentVNode("v-if", true)
                    ], 42 /* CLASS, PROPS, HYDRATE_EVENTS */, _hoisted_3$3))
                  : (vue.openBlock(), vue.createElementBlock("div", {
                      key: 1,
                      ...
                      vue.createElementVNode("header", _hoisted_1$2, [
                        (_ctx.$slots.header !== undefined && _ctx.$slots.header().length)
                          ...
                          : (vue.openBlock(), vue.createElementBlock("div", {
                              ...
                              ], 40 /* PROPS, HYDRATE_EVENTS */, _hoisted_2$2), [
                              ...
                              ], 40 /* PROPS, HYDRATE_EVENTS */, _hoisted_3$2), [
                                      ...
                                      ? (vue.openBlock(), vue.createBlock(_component_b_select, {
                                          ...
                                          default: vue.withCtx(() => [
                                            (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.listOfMonths, (month) => {
                                              ...
                                              }, vue.toDisplayString(month.name), 9 /* TEXT, PROPS */, _hoisted_5$1))
                                            }), 128 /* KEYED_FRAGMENT */))
                                          ]),
                                          _: 1 /* STABLE */
                                      ...
                                      default: vue.withCtx(() => [
                                        (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.listOfYears, (year) => {
                                          return (vue.openBlock(), vue.createElementBlock("option", {
                                            value: year,
                                            key: year
                                          }, vue.toDisplayString(year), 9 /* TEXT, PROPS */, _hoisted_6$1))
                                        }), 128 /* KEYED_FRAGMENT */))
                                      ]),
                                      _: 1 /* STABLE */
                                    }, 8 /* PROPS */, ["modelValue", "disabled", "size"])
                  ...
                  default: vue.withCtx(() => [
                    vue.createVNode(_component_b_field, {
                      ...
                      default: vue.withCtx(() => [
                        vue.createVNode(_component_b_select, {
                          ...
                          default: vue.withCtx(() => [
                            (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.hours, (hour) => {
                              ...
                              }, vue.toDisplayString(hour.label), 9 /* TEXT, PROPS */, _hoisted_1$1))
                            }), 128 /* KEYED_FRAGMENT */))
                          ]),
                          _: 1 /* STABLE */
                        }, 8 /* PROPS */, ["modelValue", "disabled"]),
                        vue.createElementVNode("span", _hoisted_2$1, vue.toDisplayString(_ctx.hourLiteral), 1 /* TEXT */),
                        vue.createVNode(_component_b_select, {
                          ...
                          default: vue.withCtx(() => [
                            (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.minutes, (minute) => {
                              ...
                              }, vue.toDisplayString(minute.label), 9 /* TEXT, PROPS */, _hoisted_3$1))
                            }), 128 /* KEYED_FRAGMENT */))
                          ]),
                          _: 1 /* STABLE */
                        }, 8 /* PROPS */, ["modelValue", "disabled"]),
                        (_ctx.enableSeconds)
                          ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 0 }, [
                              vue.createElementVNode("span", _hoisted_4$1, vue.toDisplayString(_ctx.minuteLiteral), 1 /* TEXT */),
                              vue.createVNode(_component_b_select, {
