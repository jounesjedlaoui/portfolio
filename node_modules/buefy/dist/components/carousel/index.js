...
(function (global, factory) {
      ...
      return (vue.openBlock(), vue.createElementBlock("div", {
        ...
        ($props.progress)
          ? (vue.openBlock(), vue.createElementBlock("progress", {
            ...
            }, vue.toDisplayString(_ctx.childItems.length - 1), 11 /* TEXT, CLASS, PROPS */, _hoisted_1$3))
    ...
    script$3.__file = "src/components/carousel/Carousel.vue";
    ...
    script$2.__file = "src/components/carousel/CarouselItem.vue";
    ...
    function render$1(_ctx, _cache, $props, $setup, $data, $options) {
      return (vue.openBlock(), vue.createElementBlock("figure", {
        ...
        ($options.isCaptionFirst)
          ? (vue.openBlock(), vue.createElementBlock("figcaption", _hoisted_1$1, [
        ...
        ($options.isCaptionLast)
          ? (vue.openBlock(), vue.createElementBlock("figcaption", _hoisted_4, [
              vue.renderSlot(_ctx.$slots, "caption")
            ]))
          : vue.createCommentVNode("v-if", true)
      ], 6 /* CLASS, STYLE */))
    ...
    script$1.__file = "src/components/image/Image.vue";
    ...
    exports.BCarousel = script$3;
    exports.BCarouselItem = script$2;
